                  ...
                  @foreach ($slider as $key=>$slide)
                    ...
                    <div class="item">
                        <div class="hero-wrap-item center-item">
                            <h2>{{$slide->title}}</h2>
                            <a href="#sec{{$key}}" class="hero-link custom-scroll-link">Start exploer</a>
                        </div>
                    </div>
                @endforeach
          ...
          <div class="parallax-item left-direction">
            ...
            <div class="parallax-deck" data-top-bottom="transform: translateY(-200px);" data-bottom-top="transform: translateY(200px);">
              <div class="parallax-deck-item">
                ...
                <a href="{{route('portfolio.details',[App::getLocale(),'pro_id'=>$project->projects_translations_id])}}" class="btn anim-button fl-l"><span>@lang('View_Project')</span><i class="fa fa-long-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
