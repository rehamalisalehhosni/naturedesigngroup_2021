...
@endif
{!! Form::model($item, ['method' => 'PATCH','novalidate' => 'novalidate','files' => true,'route' => ['pages.update', $item->pages_id]]) !!}
<div class="row">
	...
	<div class="tab-content">
		...
		<div id="{{$lang->code}}" class="tab-pane fade  @if($key==0)  in active  @endif ">
			@include('Backend.Pages.form', array('locale' => $lang->code,'data'=>$item->translations( $lang->code,$item->pages_id)))
		</div>
		@endforeach
