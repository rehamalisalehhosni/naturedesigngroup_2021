...
@endif
{!! Form::open(array('route' => 'about.store','method'=>'POST','novalidate' => 'novalidate','files' => true)) !!}
<div class="row">
	...
	<div class="tab-content">
		...
		<div id="{{$lang->code}}" class="tab-pane fade  @if($key==0)  in active  @endif ">
			@include('Backend.AboutUs.form', array('locale' => $lang->code))
		</div>
		@endforeach
	</div>
