...
@endif
{!! Form::model($item, ['method' => 'PATCH','novalidate' => 'novalidate','files' => true,'route' => ['offices.update', $item->offices_id]]) !!}
<div class="row">
	...
	<div class="tab-content">
		...
		<div id="{{$lang->code}}" class="tab-pane fade  @if($key==0)  in active  @endif ">
			@include('Backend.Offices.form', array('locale' => $lang->code,
												   'data'=>$item,
												   'trans_data'=>$item->translations( $lang->code,$item->offices_id)))
		</div>
		@endforeach
